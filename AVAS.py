...
import vlc
import urllib
from easygui import *                                                       # simple graphical user interface related package.
from ctypes import cast, POINTER           									# windows voice control related packages.
from comtypes import CLSCTX_ALL            									# windows voice control related packages.
from pycaw.pycaw import AudioUtilities, IAudioEndpointVolume            	# windows voice control related packages.
from flask import Flask,render_template,request,session,redirect,url_for	# Flask - Client server related packages.
from Utils import *
from global import *
from Audion import *


app = Flask(__name__)								# initialize object of flask
...
def request_blood():								#pause the on going bhajans and make the announcement and unpause the song
